...
export async function GET(req:NextRequest){
 ...
 try{
  ...
  let clearAt="";for(const r of logs){if(text(r[1])!=="CLEAR_SALES_2H"||text(r[2])!==date)continue;const at=text(r[0]);if(at>clearAt)clearAt=at}
