...
import Jakarta1Soh from "@/components/jakarta1-soh";

export default function Home(){
  return <><Jakarta1DashboardV2/><Jakarta1DailyFocus/><Jakarta1WeeklyM238/><Jakarta1Soh/><script src="/jakarta1-enhancer.js" defer /></>;
}
