...
import Jakarta1RevisionEnhancer from "@/components/jakarta1-revision-enhancer";

export default function Home(){
  return <><Jakarta1DashboardV2/><Jakarta1DailyFocus/><Jakarta1WeeklyM238/><Jakarta1RevisionEnhancer/></>;
}
