...
export default function SohTabsPage(){
 ...
 return <main className="min-h-screen bg-slate-50 p-5 text-slate-950 dark:bg-slate-900 dark:text-slate-100 sm:p-8"><a href="/" className="font-bold text-blue-600">← Dashboard</a><div className="mx-auto mt-6 max-w-7xl space-y-5"><div className="flex flex-wrap items-start justify-between gap-3"><div><h1 className="text-3xl font-black">Stock On Hand</h1><p className="mt-1 text-slate-500">SOH per kategori{updated?` • Update stock ${updated}`:""}{soldDate?` • Qty Sold ${soldDate}`:""}.</p></div><SohDataActions onChanged={load}/></div>
