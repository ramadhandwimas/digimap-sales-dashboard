...
function MoreScreen({dark,toggleDark,onAction}:{dark:boolean;toggleDark:()=>void;onAction:(action:string)=>void}){
 const groups=[
  ["Performance",[[MessageCircle,"Tambah Feedback","add-feedback"],[WalletCards,"Incentive","incentive"],[Users,"Input CX & Member","add-cx"],[ClipboardCheck,"Checklist Store","checklist"],[TrendingUp,"Aktivitas Toko","activity"]]],
